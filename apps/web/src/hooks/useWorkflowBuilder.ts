...
import { AppSection, DocumentRun, WorkflowSaveState } from "@/types";
...
export function useWorkflowBuilder() {
  ...
  const [lastUploadedRun, setLastUploadedRun] = useState<DocumentRun | null>(null);
  ...
  const workflowMutations = useWorkflowMutations({ activeWorkflowId: draftState.activeWorkflowId, fields: draftState.fields, reviewStates, savedWorkflows, setActiveWorkflowId: draftActions.setActiveWorkflowId, setDeliveryState, setLastUploadedRun, setReviewActionState, setSaveState: draftActions.setSaveState, setToastMessage, setUploadState, workflowDraft: draftState.workflowDraft });
